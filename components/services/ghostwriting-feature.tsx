      ...
      <div className="container relative z-10 mx-auto px-6 lg:px-12 text-center">
        <div className="max-w-4xl mx-auto space-y-16">
          <div className="space-y-6">
            ...
            <h2 className="font-heading text-4xl font-bold text-white md:text-6xl lg:text-7xl leading-tight">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
             <div className="space-y-4">
                ...
                <h3 className="text-lg font-bold text-white uppercase tracking-widest">Zero Trail</h3>
                <p className="text-white/40 text-sm">We maintain strict NDAs to ensure your identity as the sole creator is never compromised.</p>
             </div>
             <div className="space-y-4 border-y border-white/5 md:border-y-0 md:border-x py-8 md:py-0">
                <div className="mx-auto size-12 flex items-center justify-center rounded-full bg-accent/10 border border-accent/20 text-accent">
                   <EyeOff className="size-6" />
                </div>
                <h3 className="text-lg font-bold text-white uppercase tracking-widest">Invisible Hand</h3>
                <p className="text-white/40 text-sm">Our writers adapt perfectly to your unique syntax, tone, and professional vocabulary.</p>
             </div>
             <div className="space-y-4">
                <div className="mx-auto size-12 flex items-center justify-center rounded-full bg-accent/10 border border-accent/20 text-accent">
                   <Lock className="size-6" />
                </div>
                <h3 className="text-lg font-bold text-white uppercase tracking-widest">Ironclad Privacy</h3>
                <p className="text-white/40 text-sm">All communications and manuscript drafts are handled through secure, encrypted channels.</p>
             </div>
          </div>
        </div>
      </div>
