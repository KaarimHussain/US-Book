...
const banners = [
    {
        title: <h3 className="font-heading text-3xl font-bold leading-tight">Get Noticed With <br /> Book Publishing <br /> Services</h3>,
    ...
    {
        title: <h3 className="font-heading text-3xl font-bold leading-tight">Smart Strategies <br /> For Marketing <br /> Your Book</h3>,
    ...
    {
        title: <h3 className="font-heading text-3xl font-bold leading-tight">Elite Authors <br /> For Your <br /> Ghostwriting</h3>,
    ...
    {
        title: <h3 className="font-heading text-3xl font-bold leading-tight">Polish Your <br /> Manuscript To <br /> Perfection</h3>,
            ...
            <div className="container mx-auto px-6 lg:px-12">
                <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                    {banners.map((banner, idx) => (
                        <div
                            key={idx}
                            className={`group relative flex h-[350px] overflow-hidden rounded-2xl transition-all duration-500 hover:scale-[1.01] hover:shadow-2xl ${banner.className} p-8 lg:p-10`}
                        >
